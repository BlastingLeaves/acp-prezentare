...
function Header() {
  ...
  return (
    <header className="sticky top-0 bg-white opacity-75 z-50 shadow-lg">
      <div className="flex flex-wrap items-center justify-between p-2 mx-auto md:p-2">
        ...
        <nav className={`${ opened ? `block` : `hidden`} md:block md:flex md:items-center w-full md:w-auto pr-10 mx-auto text-2xl`}>
          ...
          <AnchorLink className='px-3 py-2 block text-black font-bold' href="#ecosistem">Descriere</AnchorLink>
